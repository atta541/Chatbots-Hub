...
//                 <h2 className={`text-2xl text-white ${darkMode ? 'text-white' : 'text-gray-800'}`}>Chat with Atta-ur-rehman  </h2>
//                 <button
...
const Atta = () => {
    ...
    return (
        ...
        <div className={`flex flex-col h-full font-sans ${darkMode ? 'bg-gray-900' : ''}`} style={{ width: '100%' }}>
            ...
            <div className="flex items-center">
                    <h2 className={`text-2xl text-black ${darkMode ? 'text-white' : 'text-gray-800'}`}>Chat with Atta-ur-rehman</h2>
                    <img src={attaprofile} alt="Atta-ur-rehman" className="ml-4 w-12 h-12 rounded-full" />
                </div>
